...
public class BlockLovoStone extends BaseBlock {
	public BlockLovoStone() {
		super(Material.ROCK);
		this.setSoundType(SoundType.STONE);
		this.setUnlocalizedName("lovo_stone");
     	this.setHardness(3F);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		...
		return Item.getItemFromBlock(Lovocraft.INSTANCE.lblocks.blocklovocobblestone);
	}
}
